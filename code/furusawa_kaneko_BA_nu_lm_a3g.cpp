...
int main(int argc, char **argv){
    ...
    fstream f2;
    stringstream name2;
    name2 << "result/270_" << alpha1_in << "_" << alpha2_in << "_" << nu_in
          << "_mean_barabasi_Ddep_LM.txt";
    ...
    fstream f1;
    stringstream name1;
    name1 << "result/" << D_in << "_" << alpha1_in << "_" << alpha2_in << "_" << nu_in
          << "_mean_barabasi_a3gdep_LM.txt";
    f1.open(name1.str().c_str(), ios::out);

    for(int alpha3_g_in = 540; alpha3_g_in>0; alpha3_g_in--){
